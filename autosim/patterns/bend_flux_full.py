#!/usr/bin/env python3
"""
Pattern: bend_flux_full
Complete waveguide bending loss example: 2 simulations (straight/bent), flux save/load, transmittance calculation
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "bend_flux_full"
_t0 = _time.time()
