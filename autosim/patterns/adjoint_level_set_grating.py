#!/usr/bin/env python3
"""
Pattern: adjoint_level_set_grating
Level-set based topology optimization: LevelSetObjective, phase-field parameterization
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "adjoint_level_set_grating"
_t0 = _time.time()
