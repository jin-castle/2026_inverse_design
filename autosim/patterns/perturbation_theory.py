#!/usr/bin/env python3
"""
Pattern: perturbation_theory
Perturbation theory: Calculation of resonant frequency shift according to refractive index change. First-order perturbat
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "perturbation_theory"
_t0 = _time.time()
