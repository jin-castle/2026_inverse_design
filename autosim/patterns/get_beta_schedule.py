#!/usr/bin/env python3
"""
Pattern: get_beta_schedule
Multi-phase beta schedule for gradual binarization in adjoint topology optimization. Phase 1 (iter 1-20): beta=2 (hold, 
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "get_beta_schedule"
_t0 = _time.time()
