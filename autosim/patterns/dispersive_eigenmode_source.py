#!/usr/bin/env python3
"""
Pattern: dispersive_eigenmode_source
Dispersive media eigenmode source: eigenmode excitation in dispersive materials. eig_band, frequency setting
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "dispersive_eigenmode_source"
_t0 = _time.time()
