#!/usr/bin/env python3
"""
Pattern: polarization_grating
Polarization grating simulation: Jones matrix, polarization-dependent transmittance, circular polarization
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "polarization_grating"
_t0 = _time.time()
