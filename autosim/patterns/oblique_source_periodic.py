#!/usr/bin/env python3
"""
Pattern: oblique_source_periodic
Oblique incidence periodic structure: Bloch boundary + oblique source, transmittance by angle
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "oblique_source_periodic"
_t0 = _time.time()
