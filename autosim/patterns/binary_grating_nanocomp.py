#!/usr/bin/env python3
"""
Pattern: binary_grating_nanocomp
NanoComp MEEP binary grating: latest API, FluxRegion, k_point, transmittance efficiency calculation
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "binary_grating_nanocomp"
_t0 = _time.time()
