#!/usr/bin/env python3
"""
Pattern: mode_coeff_phase
Mode coefficients and phase: Simultaneous extraction of mode coefficient magnitude/phase, phase matching condition
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "mode_coeff_phase"
_t0 = _time.time()
