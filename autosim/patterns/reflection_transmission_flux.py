#!/usr/bin/env python3
"""
Pattern: reflection_transmission_flux
Simultaneous measurement of reflectance/transmittance: 2 FluxRegions, reference simulation + actual simulation, flux nor
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "reflection_transmission_flux"
_t0 = _time.time()
