#!/usr/bin/env python3
"""
Pattern: dft_fields_extraction
Extract DFT (Discrete Fourier Transform) field arrays from MEEP simulation. Register a DFT monitor with sim.add_dft_fiel
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "dft_fields_extraction"
_t0 = _time.time()
