#!/usr/bin/env python3
"""
Pattern: angular_reflection_measurement
Angle-dependent reflectance: k_point sweep, PlaneWaveSource, FluxRegion reflection measurement
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "angular_reflection_measurement"
_t0 = _time.time()
