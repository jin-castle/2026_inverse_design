#!/usr/bin/env python3
"""
Pattern: binary_grating_diffraction
Binary diffraction grating FDTD: k_point sweep, flux measurement of each diffraction order, efficiency calculation
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "binary_grating_diffraction"
_t0 = _time.time()
