#!/usr/bin/env python3
"""
Pattern: mpi_parallel_simulation
Run MEEP simulation with MPI parallelization. Command: mpirun -np N python script.py. Use mp.am_master() guard for file 
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "mpi_parallel_simulation"
_t0 = _time.time()
