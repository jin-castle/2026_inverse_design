#!/usr/bin/env python3
"""
Pattern: cylinder_cross_section
Cylindrical scattering cross section: total_field_scattered_field, near2far, scattering efficiency
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "cylinder_cross_section"
_t0 = _time.time()
...
try:
    ...
    if mp.am_master():
        ...
        plt.tight_layout()
        plt.savefig(str(RESULT_DIR / "cylinder_cross_section" / "cylinder_cross_section.png"))
    # ─────────────────────────────────────────────────────────
