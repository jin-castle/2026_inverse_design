#!/usr/bin/env python3
"""
Pattern: antenna_radiation_pattern
Antenna radiation pattern: EED/MED source, near2far, 3D radiation pattern visualization
"""
import sys, os, time as _time
sys.path.insert(0, "/root/autosim")
from common import *  # silicon, oxide, resolution, RESULT_DIR, etc.

_PATTERN = "antenna_radiation_pattern"
_t0 = _time.time()
